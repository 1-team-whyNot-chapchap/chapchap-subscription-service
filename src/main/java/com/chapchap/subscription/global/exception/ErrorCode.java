...
public enum ErrorCode {
    ...
    , SETTING_CHANGE_PAYMENT_DECLINED("PAYMENT_009", HttpStatus.CONFLICT, "설정 변경 추가 결제가 승인되지 않았습니다.")
    ...
    , SUBSCRIPTION_CHANGE_CONFIRMATION_NOT_FOUND("SUBSCRIPTION_006", HttpStatus.NOT_FOUND, "확인할 증액 설정 변경이 없습니다.")
    , SUBSCRIPTION_CANCELLATION_NOT_ALLOWED("SUBSCRIPTION_007", HttpStatus.CONFLICT, "현재 상태에서는 해지 또는 시작 전 취소를 할 수 없습니다.")
    , SUBSCRIPTION_PRE_START_CANCELLATION_DEADLINE_PASSED("SUBSCRIPTION_008", HttpStatus.CONFLICT, "시작 전 취소 마감 시각이 지났습니다.")
    , SUBSCRIPTION_KAFKA_DELIVERY_COMPLETED("SUBSCRIPTION_009", HttpStatus.CONFLICT, "대상 주문의 Kafka 전달이 완료되어 취소할 수 없습니다.")
